  ...
  return (
    <Layout>
      <div className="flex h-[calc(100vh-4rem)] -mx-4 md:-mx-6">
        <div className="w-full md:w-80 border-r border-border bg-card flex-shrink-0">
          <div className="p-4 border-b border-border">
            <h2 className="text-lg md:text-xl font-bold">{t('chat.title')}</h2>
          </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {conv.unread > 0 && (
                        <span className="bg-primary text-primary-foreground text-xs rounded-full px-2 py-0.5 flex-shrink-0 ml-2">
                          {conv.unread}
                        </span>
                      )}
                    </div>
          ...
          <div className="p-4 border-b border-border bg-card">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <h3 className="font-semibold truncate">Lucia Schaefer</h3>
          ...
          <div className="flex-1 p-4 md:p-6 overflow-y-auto">
            <div className="space-y-4 max-w-3xl mx-auto">
              <div className="flex gap-3">
                ...
                <div className="bg-secondary rounded-lg px-4 py-2 max-w-[80%] md:max-w-md">
                  <p className="text-sm">Salut ! Comment vas-tu ?</p>
                </div>
              </div>
              <div className="flex gap-3 justify-end">
                <div className="bg-primary text-primary-foreground rounded-lg px-4 py-2 max-w-[80%] md:max-w-md">
